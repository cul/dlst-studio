...
To create a face shield, one needs access to a 3D printer, cutting tools for the shield itself, and the ability to sterilize the shields with disinfectants once they are produced.

## Printing

### Raw materials

1. Filament (PLA, ABS). We used PLA filament from Verbatim, Dremel, and MakerBot
...
6. Rubbing alcohol, bleach, and other disinfectants.
...
1. 3D Model itself printers: notes technical specification of the print itself

### Printing Instructions

Before printing:
  1. Disable Raft
  2. Set layer height to 0.3 mm
  3. First layer height 
  4. Set infill to 10%
  5. Set fill pattern to triangle
  6. 2 parameter shells
  7. 2 top solid layers 
  8. 2 bottom solid layers

### Assembly instructions

1. Wear vinyl gloves and a face mask while working.
2. Print out the visor component on the 3D printer.
3. With scissors, cut the transparent material to a sheet of 11in (27.9cm) x 8.5in (21.6cm). You can use a sheet of US letter as a guide, if your transparent material is too large. A4 paper may be too long for most users.
4. With scissors, cut the elastic band to about 31in (79cm).
5. With scissors, cut the foam tape to 9.5in (24.1cm). Once the visor is printed, you can use it as a guide.
...
12. Wash your hands for at least 20 seconds prior to bagging the masks. Clean the masks. The brand of the particular material that we are using can be wet and wiped down. We used bleach spray. Once the masks are dry, bag them in the packaging. Hospitals will take their own precautions once they have received the items. Handle the masks carefully and keep them in a secure space free of crowds of people. Limit who touches the masks to the person making them and the person bagging them. They should not be passed around to multiple hands. 


### Tips on obtaining equipment in collaboration with admins at unis/libraries

Many Libraries and Universities today usually have maker spaces and other spaces with 3D printers today. If you don't own one, you may want to work with top administrators to get access to these printers. An email to the University Librarian, the Chair of Engineering, or even the Provost might get you access to otherwise locked buildings to retrieve the equipment and take it to your work. Remember that for the full protective shield, you will also need laser cutters and a few other tools. Another possible solution is to reserve the spaces that have all the tools for this use by working with your administrators. 
